...
import 'package:pinterest_project/view_models/search_view_model.dart';
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context){
                      return DetailPage(viewModel.spotLightRandom[viewModel.spotLightRandom.length - 1].urls!.small!);
                    })
                    );
                  },
                  child: Container(
        ...
        child: MasonryGridView.builder(
          ...
          itemBuilder: (context, index){
            return GestureDetector(
              onTap: (){
                Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext context){
                  return DetailPage(viewModel.gridViewRandom[index].urls!.small!);
                })
                );
              },
              child: SizedBox(
